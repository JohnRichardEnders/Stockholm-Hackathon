...
YouTubeFactChecker.prototype.createClaimOverlay = function (factCheck, index) {
  ...
  overlay.style.cssText = `
    position: absolute; top: ${20 + index * 70}px; right: 20px; max-width: 320px; background: rgba(0, 0, 0, 0.92);
    ...
    )}; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.4); transform: translateX(100%); opacity: 0; transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94);
